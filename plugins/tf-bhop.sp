...
public void OnPluginStart()
{
	...
	sv_enablebunnyhopping = CreateConVar("sv_enablebunnyhopping", "0", "Allow player speed to exceed maximum running speed");
	sv_enablebunnyhopping.AddChangeHook(ConVarChanged_PreventBunnyJumping);
	sv_autobunnyhopping = CreateConVar("sv_autobunnyhopping", "0", "Players automatically re-jump while holding jump button");
	...
	sv_duckbunnyhopping = CreateConVar("sv_duckbunnyhopping", "0", "Allow jumping while ducked");
